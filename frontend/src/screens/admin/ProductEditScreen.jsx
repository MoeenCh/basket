                ...
                {isLoading ? <Loader /> : error ? <Message varient='danger'>{error}</Message> : (
                    <Form onSubmit={submitHandler}>
                        ...
                        <Form.Group controlId='image' className='my-2'>
                            ...
                            <Form.Control type='text' placeholder='Enter Image' value={image} onChange={(e) => setImage}></Form.Control>
                            <Form.Control type='file' label='Choose file' onChange={uploadFileHandler} className='my-2'></Form.Control>
                        </Form.Group>
