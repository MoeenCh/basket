...
const OrderScreen = () => {
    ...
    const [payOrder, { isLoading: loadingPay }] = usePayOrderMutation();//rtk query

    const [deliverOrder, { isLoading: loadingDeliver }] = useDeliverOrderMutation()

    const [{ isPending }, paypalDispatch] = usePayPalScriptReducer();

    const { data: paypal, isLoading: loadingPayPal, error: errorPayPal } = useGetPayPalClientIdQuery();//rtk query
